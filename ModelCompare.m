...
% Model 5
figure(5);
[t,y] = ode113(@Model5,[0,720],[0; 5950; 0; 3000.2; 50.4]);
plot(t,y(:,5)/4.2,'-o');

% Model 6
figure(6);
[t,y] = ode113(@Model6,[0,720],[0; 5950; 0; 3000.2; 50.4]);
plot(t,y(:,5)/4.2,'-o');
...
% Model 8
figure(8);
[t,y] = ode113(@Model8,[0,720],[0; 5950; 0; 50.4]);
plot(t,y(:,4)/4.2,'-o');

% Model 9
figure(9);
[t,y] = ode113(@Model9,[0,720],[0; 5950; 0; 50.4]);
plot(t,y(:,4)/4.2,'-o');

% Model 10
figure(10);
[t,y] = ode113(@Model10,[0,720],[0; 5950; 0; 50.4]);
plot(t,y(:,4)/4.2,'-o');
